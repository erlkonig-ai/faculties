...
pub mod content_part {
    ...
    attributes! {
        ...
        "63C7750587AD040429750C15BAB9CF29" as pub ordinal: U256BE;
        /// IDENTITY. Canonical semantic datum at this position.
        "28E039E5B292CEE5E41C22EDD0E396E7" as pub fact: GenId;
        ...
        "A7CC0F4A24275330DD48F2836B70F0EC" as pub responds_to: GenId;
    }
...
pub mod content_fact {
    ...
    attributes! {
        ...
        "9B38698BD76DB91C8ED478D304375286" as pub asset_namespace: GenId;
        /// IDENTITY when known. Link to Files' intrinsic canonical media-type
        /// entity, never an inline MIME spelling.
        "CCEC81B576FF10DDA85C522C6FE86345" as pub media_type: GenId;
...
pub mod source_projection {
    ...
    attributes! {
        ...
        "3D9FCD3A68CBFBCFD7375E35D63FB87D" as pub source_namespace: GenId;
        /// IDENTITY. Vendor id scoped by session, or an append-stable fallback
        /// coordinate. Never a movable filesystem path by itself.
        "5F3F80B819EBFB04E2AF20852F9FE3E3" as pub source_locator: Handle<LongString>;
        /// IDENTITY. Exact raw source record bytes.
        "584415CC85A866E45B91C2673C7F794E" as pub raw_record: Handle<RawBytes>;
        /// IDENTITY. Canonical block produced by this projection.
        "3810AAD922D0523B9A609E4E1EBA9320" as pub projects_to: GenId;

        /// NONIDENTITY. Source-level predecessor receipt(s), including edges
        /// that could not truthfully become canonical block predecessors.
        "1CE3ACF6B860D6009BA4CB622FBE1DC9" as pub previous: GenId;
        /// NONIDENTITY. Genuine source timestamp claim, when decodable.
        "A6892FD4C7FEB9445C3C5F8E96FC9E6A" as pub source_timestamp: NsTAIInterval;
        ...
        /// the occurrence.
        "EBE88D7DDF43CCC594A695504B599AA5" as pub experiencer: GenId;
        /// NONIDENTITY. Exact vendor author label retained for provenance.
        "01BA2CB9FF56564100D64C81D0391E28" as pub raw_author: Handle<LongString>;
        /// NONIDENTITY. Exact vendor role label retained for provenance.
        "2874AFE6553B4E044D4EBFB8FA89A641" as pub raw_role: Handle<LongString>;
        /// NONIDENTITY. Exact vendor model label retained for provenance.
        "CEB26C9520076D245DF83F77D994A800" as pub raw_model: Handle<LongString>;
    }

...
pub mod posture {
    ...
    attributes! {
        ...
        "0CB41E9330855B39E59686D54CD091DE" as channel_name: inlineencodings::Handle<blobencodings::LongString>;
        /// Term → the string to look for. Matched case-insensitively.
        "2618BF2D4418EA1D006815517CA41927" as term: inlineencodings::Handle<blobencodings::LongString>;
        /// Term → the channel it is protected FROM.
        "6860CCB7DCCEA0BE95BC07A35DCD5CBE" as in_channel: inlineencodings::GenId;
        /// Term → why it is protected. Carried because a bare wordlist rots:
        /// nobody dares remove an entry whose reason nobody recorded.
        "0B86BA9EB3A1B6FD0C70AC7B75A24E06" as why: inlineencodings::Handle<blobencodings::LongString>;
        /// Policy revision → one exact term or exemplar member. Repeated.
        ///
        /// Minted with `trible genid` on 2026-08-08:
        /// `245EFCA76A6AAA2A17F512548C87A7E7`.
        "245EFCA76A6AAA2A17F512548C87A7E7" as policy_member: inlineencodings::GenId;
        /// Term/exemplar → its explicit policy role.
        ///
        /// Minted with `trible genid` on 2026-08-08:
        /// `50DCC5C0FB746CC15772710DEBB65B1E`.
        "50DCC5C0FB746CC15772710DEBB65B1E" as role: inlineencodings::GenId;
        /// Finding → the scan that produced it.
        "AD904325C9E0EE6A62DA4E9C731E9714" as scan: inlineencodings::GenId;
        /// Finding → the document it was found in.
        "81AD29AAC2A2E3C60207E433B5BB35D7" as document: inlineencodings::GenId;
        /// Document → its path as scanned.
        "46DCFC71243F75A716E96933671AF2AD" as path: inlineencodings::Handle<blobencodings::LongString>;
        /// Finding → where inside the document ("docProps/core.xml:lastModifiedBy").
        "8D48ED59152DEC32A8AE9E60816499B1" as locator: inlineencodings::Handle<blobencodings::LongString>;
        ...
        "2DD2823925C7DDA38CE3A5ECA82CAD52" as value: inlineencodings::Handle<blobencodings::LongString>;
        /// Scan → the root path it was pointed at.
        "8CAF5292A19C695755E3CBD9E1BD4F2E" as target: inlineencodings::Handle<blobencodings::LongString>;
        /// Scan → a modality it DID apply.
        "A4E0193BBC1935D183A7447A93CE8B08" as checked: inlineencodings::GenId;
        /// Scan → a modality it did NOT apply. The anti-"clean" attribute: a
        /// scan is only as trustworthy as the gaps it admits.
        "EAE05B8465E40ABAD9CBDA52DA83B759" as unchecked: inlineencodings::GenId;
        /// Scan → how many files it walked.
        "4489D34BE64CF6A8D2D923D4859A4399" as file_count: inlineencodings::U256BE;
        /// Document → exactly one scan outcome (`examined`, `unsupported`, or
        /// `parse-failed`).
        ///
        /// Minted with `trible genid` on 2026-08-08:
        /// `B1D289B991914D06298A45E2D3F828F6`.
        "B1D289B991914D06298A45E2D3F828F6" as outcome: inlineencodings::GenId;
        /// Scan → a freshly generated occurrence anchor. It makes repeated
        /// observations distinct while the enclosing scan remains intrinsic.
        ///
        /// Minted with `trible genid` on 2026-08-08:
        /// `DFBEBF94BA5910FFE67D9153BA47700E`.
        "DFBEBF94BA5910FFE67D9153BA47700E" as occurrence: inlineencodings::GenId;
        /// Parse failure or walk omission → exact diagnostic text.
        ///
        /// Minted with `trible genid` on 2026-08-08:
        /// `6E46C2DC054717AF129BD0D2CC730D69`.
        "6E46C2DC054717AF129BD0D2CC730D69" as detail: inlineencodings::Handle<blobencodings::LongString>;
    }
}

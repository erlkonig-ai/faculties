...
const TOOLS: &[Tool] = &[
    Tool {
        name: "files_add",
        description: "Import a file from base64-encoded original bytes. Name is a leaf filename, never a server path.",
    ...
    Tool {
        name: "files_fetch", description: "Fetch a URL and import its bytes as a file.",

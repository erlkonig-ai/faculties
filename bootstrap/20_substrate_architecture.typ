...
== One contract per boundary
  ...
  - A faculty reads and writes the workspace *as if it were the
    only writer*: open the pile (wiki:5232ea531fedfcb17bf15e88c3d52a36), append facts
    (wiki:4e19893b36bf37d471bb9ea968edac20), advance its own branch. There is no sync
...
Another agent's goals simply appear in compass
(wiki:7cdd48c272ff344628fe74f4c07783e4), their messages in local-messages
(wiki:65c6965cb3d11052e87804527734a697), the team's current situation in orient
(wiki:ff27b500d93e1d545b7465438a0146e1). Write as if alone, read as if omniscient;
...
Next stop: wiki:7cdd48c272ff344628fe74f4c07783e4 — Compass Goals Workflow.

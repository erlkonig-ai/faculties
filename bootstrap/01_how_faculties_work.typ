...
that all read and write the same TribleSpace pile
(wiki:5232ea531fedfcb17bf15e88c3d52a36). The canonical upstream is
...
== Mental model
  ...
  - One faculty = one cognitive verb: `compass` for goals
    (wiki:7cdd48c272ff344628fe74f4c07783e4), `wiki` for knowledge fragments
    (wiki:82129c70b693f7e2d781d78ac5efbb86), `files` for archived artefacts
    (wiki:b08448855de9cce7610d68dac2555003), `local_messages` for direct messages
    (wiki:65c6965cb3d11052e87804527734a697), and so on.
  - Each faculty owns a *branch* in the pile (`compass`,
    `wiki`, `files`, …) and writes its own signed commits
    there. Branches merge independently — touching `compass`
    never invalidates `wiki` (wiki:5cc10e2b0263008b261cf8a1ef30bd8c).
...
Next stop: wiki:4e19893b36bf37d471bb9ea968edac20 — Substrate 1/4: What Is a Trible.
